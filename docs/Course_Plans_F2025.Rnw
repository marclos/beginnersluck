...
xlsxpath = "/home/mwl04747/beginnersluck/docs/CoursePlanDatabaseFall2025.xlsx"
...
Updated: April, 15, 2025 %\Sexpr{format(Sys.Date(), "%B %d, %Y")}

<<echo=FALSE>>=
advisors.sbe = subset(advisors, subset=CoursePlan=="SBE")
electives.sbe = subset(electives, subset=!is.na(electives[,4]), select=c("CourseNo", "Title", "Offered", "SBE", "Course"))
@
...
For example, \Sexpr{electives.sbe$Course[electives.sbe$SBE=="R"]}.

<<echo=FALSE, results='asis', eval=FALSE, fig.cap="Potential Representation Courses">>=
...
Examples might include: \Sexpr{electives.sbe$Course[electives.sbe$SBE=="D"]}.

<<echo=FALSE, results='asis', eval=FALSE, fig.cap="Potential Design Courses">>=
...
\noindent Electives might include: \Sexpr{electives.sbe$Course[electives.sbe$SBE=="E"]}.

<<echo=FALSE, results='asis', eval=FALSE>>=
print(xtable(subset(electives.sbe, subset=electives.sbe$SBE=="E", select= -SBE)), include.rownames=FALSE)
@
...
values.values = subset(courses, subset=Values=="values", select=c("CourseNo", "Title", "Course", "Offered", "Values"))
values.social = subset(courses, subset=Values=="social", select=c("CourseNo", "Title", "Course", "Offered", "Values")) 
@
...
\begin{itemize*}
  ...
  \item \Sexpr{values.values$Course[8]}
    \item \Sexpr{values.values$Course[9]}
\end{itemize*}

\item[Social Science Applications] to build content specialization, students will take three of the following \Sexpr{nrow(values.social)} courses: \Sexpr{values.social$Course}
