...
Thus, we have now calculated the speed as \Sexpr{round(nu, 2)}.\footnote{However, I am not sure this is right. Did you get this as a intermediate answer with your prof? I need to figure out the units too!}
...
The the slope should be h!  where h is \Sexpr{round(coef(lm(lambda~volts))[1], 2)}
