...
Today, the estimated peak for covid-19 in LA will be `r LApeak` and `r Orangepeak` for Los Angeles and Orange County, respectively, as modeled on `r Sys.Date()`. 
