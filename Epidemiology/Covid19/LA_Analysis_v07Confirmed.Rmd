...
LA2.dates = seq(as.Date("2020-03-27"), as.Date("2020-04-04"), 1); LA2.dates
LA3.dates = seq(as.Date("2020-04-04"), max(LA$Date)+1, 1); LA3.dates
...
Orange1.dates = seq(as.Date("2020-03-19"), as.Date("2020-03-29"), 1)
Orange2.dates = seq(as.Date("2020-03-27"), max(Orange$Date)+1, 1)

Orange1 = subset(Orange, subset=(Date>=min(Orange1.dates) - 1 &  Date<=max(Orange1.dates)-1)); nrow(Orange1); Orange1$Date
Orange2 = subset(Orange, subset=Date>=min(Orange2.dates)+1); Orange2$Date
...
Orange2.dr = as.vector(round(log(2)/Orange2.lm$coef[2],1)); Orange2.dr
...
text(as.Date("2020-03-23"), 8.7,paste("Current LA Doubling Rate =", LA3.dr), col='darkblue')
text(as.Date("2020-04-01"), 4.0, paste("Current Orange Doubling Rate =", Orange2.dr), col='darkorange')
...
Today, the estimated peak for covid-19 in LA will be `r round(x0[1], -2)` as modeled on `r Sys.Date()`. This is a terribly unreliable prediction method! In addition, the N doesn't not always align with "K" and I have no idea way. 
