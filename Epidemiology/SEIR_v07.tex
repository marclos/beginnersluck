...
\subsection{Modeling SIR  with R}
...
\hlstd{parameters} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlkwc{beta} \hlstd{=} \hlnum{1.4247}\hlstd{,} \hlkwc{gamma} \hlstd{=} \hlnum{0.14286}\hlstd{)}
\hlstd{times} \hlkwb{<-} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,} \hlnum{70}\hlstd{,} \hlkwc{by} \hlstd{=} \hlnum{1}\hlstd{)}
